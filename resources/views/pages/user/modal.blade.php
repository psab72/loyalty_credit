                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" readonly class="form-control-plaintext kyc-input" id="staticEmail" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="staticMerchantName" class="col-md-6 col-form-label">Merchant Name</label>
                                <div class="col-md-6">
                                    <input type="text" readonly class="form-control-plaintext kyc-input" id="staticMerchantName" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="staticMobileNumber" class="col-md-6 col-form-label">Mobile Number</label>
                                <div class="col-md-6">
                                    <input type="text" readonly class="form-control-plaintext kyc-input" id="staticMobileNumber" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="staticEstablishmentName" class="col-md-6 col-form-label">Establishment Name</label>
                                <div class="col-md-6">
                                    <input type="text" readonly class="form-control-plaintext kyc-input" id="staticEstablishmentName" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="staticDateOfBirth" class="col-md-6 col-form-label">Date of Birth</label>
                                <div class="col-md-6">
                                    <input type="text" readonly class="form-control-plaintext kyc-input" id="staticDateOfBirth" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="staticPlaceOfBirth" class="col-md-6 col-form-label">Place of Birth</label>
                                <div class="col-md-6">
                                    <input type="text" readonly class="form-control-plaintext kyc-input" id="staticPlaceOfBirth" value="">
                                </div>
                            </div>
                            {{--<div class="form-group row">--}}
                                {{--<label for="staticAddress" class="col-md-6 col-form-label">Address</label>--}}
                                {{--<div class="col-md-6">--}}
                                    {{--<input type="text" readonly class="form-control-plaintext kyc-input" id="staticAddress" value="">--}}
                                {{--</div>--}}
                            {{--</div>--}}
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" readonly class="form-control-plaintext kyc-input" id="staticNationality" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="staticSourceOfIncome" class="col-md-6 col-form-label">Source of Income</label>
                                <div class="col-md-6">
                                    <input type="text" readonly class="form-control-plaintext kyc-input" id="staticSourceOfIncome" value="">
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="staticStatus" class="col-md-6 col-form-label">Status</label>
                                <div class="col-md-6">
                                    <input type="text" readonly class="form-control-plaintext kyc-input" id="staticStatus" value="">
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
